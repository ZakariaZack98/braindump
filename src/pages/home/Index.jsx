...
import NotePrompt from "../../components/home/NotePrompt";

const Home = () => {
  const [notePromptOpen, setNotePromptOpen] = useState(false);

  return (
    <div className="w-screen h-screen body bg-center bg-cover relative">
      {notePromptOpen && <NotePrompt onClose={() => setNotePromptOpen(false)}/>}
      <div className="overlay h-screen w-screen overflow-auto">
        <div className="w-3/4 mx-auto my-[3dvh]">
          <div className="flex justify-between items-center">
            ...
            <ButtonBlue label={'+ Add new note'} clickHandler={() => setNotePromptOpen(true)}/>
          </div>
